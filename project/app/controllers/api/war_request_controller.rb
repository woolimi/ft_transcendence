class Api::WarRequestController < ApplicationController
    ...
    def create
        ...
        war = War.create(guild_1: guild_1, guild_2: guild_2, guild_1_score: 0, guild_2_score: 0,guild_1_matches_won: 0, guild_2_matches_won: 0, guild_1_matches_lost: 0, guild_2_matches_lost: 0, guild_1_matches_unanswered: 0, guild_2_matches_unanswered: 0, wager: arr[2], max_unanswered: arr[3], status: 0, start_date: arr[4], end_date: arr[5])
        war.save()
    end
